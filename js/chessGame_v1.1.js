...
//Highlights the selected cell with the highlight color by x, y coordinates
        ...
        this._get_valid_moves = (piece) => {
            ...
            let moves = this._get_moves(piece);
            ...
            for(let m of moves){
                ...
                act_piece.x_pos = m.X;
                act_piece.y_pos = m.Y;
                let check_status = this._is_check(test_table);
                if(!check_status){
                    valid_moves.push(m);
                }
            }
        ...
        this._move_piece_to = (x, y, team) => {

            let piece = team.find(element => element.x_pos === selected_piece.x_pos && element.y_pos === selected_piece.y_pos);
